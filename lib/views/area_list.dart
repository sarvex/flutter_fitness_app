...
class AreaListView extends StatefulWidget {
  ...
  const AreaListView({Key key, this.mainScreenAnimationController, this.mainScreenAnimation}) : super(key: key);
  @override
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget child) {
        return FadeTransition(
          ...
          child: new Transform(
            transform: new Matrix4.translationValues(0.0, 30 * (1.0 - widget.mainScreenAnimation.value), 0.0),
            child: AspectRatio(
              aspectRatio: 1.0,
              child: Padding(
          ...
          child: new Transform(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: <BoxShadow>[
                  BoxShadow(color: AppTheme.grey.withOpacity(0.4), offset: Offset(1.1, 1.1), blurRadius: 10.0),
                ],
              ),
              child: Material(
