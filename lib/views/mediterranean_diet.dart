                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                SizedBox(
                                                  width: 28,
                                                  height: 28,
                                                  child: Image.asset("images/eaten.png"),
                                                ),
                                                Padding(
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                SizedBox(
                                                  width: 28,
                                                  height: 28,
                                                  child: Image.asset("images/burned.png"),
                                                ),
                                                Padding(
                                                  padding: const EdgeInsets.only(left: 4, bottom: 3),
                                                  child: Text(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border:
                                            new Border.all(width: 4, color: AppTheme.nearlyDarkBlue.withOpacity(0.2)),
                                      ),
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                  ...
                                  Padding(
                                    ...
                                    child: CustomPaint(
                                      painter: CurvePainter(
                                          colors: [AppTheme.nearlyDarkBlue, HexColor("#8A98E8"), HexColor("#8A98E8")],
...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final shdowPaintRadius = math.min(size.width / 2, size.height / 2) - (12 / 2);
    canvas.drawArc(new Rect.fromCircle(center: shdowPaintCenter, radius: shdowPaintRadius), degreeToRadians(278),
