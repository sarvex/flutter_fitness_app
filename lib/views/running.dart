...
class RunningView extends StatelessWidget {
  ...
  const RunningView({Key key, this.animationController, this.animation}) : super(key: key);
                      ...
                      Padding(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            boxShadow: <BoxShadow>[
                              BoxShadow(
                                  color: AppTheme.grey.withOpacity(0.4), offset: Offset(1.1, 1.1), blurRadius: 10.0),
                            ],
                          ),
                          child: Stack(
