import '../views/body_measurement.dart';
import '../views/glass.dart';
import '../views/mediterranean_diet.dart';
import '../views/title.dart';
import '../theme.dart';
import '../diary/meal_list.dart';
import '../diary/water_view.dart';
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        ...
        animation: Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController, curve: Interval((1 / count) * 0, 1.0, curve: Curves.fastOutSlowIn))),
    ...
    listViews.add(
      TitleView(
        ...
        animation: Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController, curve: Interval((1 / count) * 6, 1.0, curve: Curves.fastOutSlowIn))),
        animationController: widget.animationController,
      ),
    );
        ...
        AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget child) {
            return FadeTransition(
              ...
              child: new Transform(
                transform: new Matrix4.translationValues(0.0, 30 * (1.0 - topBarAnimation.value), 0.0),
                child: Container(
